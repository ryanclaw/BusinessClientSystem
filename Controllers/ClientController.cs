...
namespace BusinessClientSystem.Controllers
{
    public class ClientController : Controller
    {
         ...
         [HttpPost]
         public RedirectResult New1( string salutation, string firstname, string lastname, 
        ...
        [HttpPost]
         ...
         [HttpPost]
         public RedirectResult Update1(int id, string salutation, string firstname, string lastname, string gender,
         string dateofBirth, string address1, string address2, int phone1, int phone2, string email)
         {
            BusinessClient cs = new BusinessClient();
            Clients newClient = new Clients();
